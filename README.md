...
### Stage 3 — AI Layer `[ частично завершён ]`
> Цель: AI-генерация сопроводительных писем

- [x] OpenAI интеграция
- [x] Промпт под профиль (портфолио, стек, стиль)
- [x] Команда `/coverletter`
- [x] Короткий HH-style отклик без AI-клише
...
| Published At | Дата публикации вакансии HH |
